---
name: python-flask-stack-expert-enhanced
description: Enhanced version of python-flask-stack-expert with deep Attack-a-Crack CRM knowledge. Use for Flask application architecture, SQLAlchemy ORM patterns, service registry implementation, background tasks with Celery, and Attack-a-Crack specific patterns.
