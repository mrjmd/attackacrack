...
class TestVariantAssignment(TestABTestResultRepository):
...
class TestMetricsTracking(TestABTestResultRepository):
...
class TestMetricsAggregation(TestABTestResultRepository):
...
class TestBulkOperations(TestABTestResultRepository):
...
class TestDataIntegrity(TestABTestResultRepository):
