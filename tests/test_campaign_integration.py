...
from crm_database import (
    Contact, Campaign, CampaignList, CampaignRecipient,
    CampaignMessage, Property, ContactProperty
)
...
class TestCampaignIntegration:
    ...
    def sample_campaign(self):
        ...
        campaign = Campaign(
            ...
            type="sms",
            status="draft",
            message_template="Hi {first_name}, this is a test message for {city} residents.",
            total_recipients=0,
            sent_count=0
        )
