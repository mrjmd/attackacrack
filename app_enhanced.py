# app_enhanced.py - Enhanced version with lazy loading and proper initialization order
...
def create_app(config_name=None, test_config=None):
    ...
    # Initialize Flask-Session AFTER blueprints
...
def _create_appointment_service(google_calendar, db_session):
    ...
    # Use the refactored version when ready
